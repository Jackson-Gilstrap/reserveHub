        ...
        <table className="border-collapse table-auto mx-auto my-2">
          <thead>
            <tr>
              ...
              <th className="border border-slate-600 text-left px-2">Street Address</th>
              <th className="border border-slate-600 text-left px-2">City</th>
              <th className="border border-slate-600 text-left px-2">State</th>
              <th className="border border-slate-600 text-left px-2">Zipcode</th>
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-slate-600 text-center px-2">Oneonta</td>
              <td className="border border-slate-600 text-center px-2">NY</td>
              <td className="border border-slate-600 text-center px-2">13820</td>
